...
Regardless of file location, paths to requirements 2-7 MUST be declared at mk-gatk/analysis/config.mk
...
INDELs: path to gold standart INDEL vcf reference file.

dbSNP: path to dbSNP vcf reference file.

HAPMAP: path to HAPMAP vcf reference file.

OMNI: path to OMNI vcf reference file.

OTG: path to 1000 genomes project vcf reference file.

NT: Number of threads for GATK parallelization.
